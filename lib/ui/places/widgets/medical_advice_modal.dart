...
class _MedicalAdviceModalState extends State<MedicalAdviceModal> {
  ...
  final Map<String, String> _englishContent = {
    keyBooking: "Public & University: Use MHRS app or call 182. For Hacettepe, use My Hacettepe portal.\nPrivate: Direct booking via website or WhatsApp.",
    keyLanguage: "Public: Translators recommended. Private/University: Look for the 'International Patient Office'.",
    keyInsurance: "SGK: Available after 1 year residency. Private Insurance: Essential for visas. Emergencies: Free at public hospitals.",
    keyDocuments: "1. Passport or Residence ID.\n2. Insurance documents.\n3. Past medical records.",
  };
  ...
  Widget build(BuildContext context) {
    ...
    String getText(String arText, String enKey) {
      ...
      if (isTurkish && _translatedContent != null && _translatedContent!.containsKey(enKey)) {
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                Row(
                  children: [
                    Icon(LucideIcons.info, color: Theme.of(context).primaryColor, size: 28),
