...
class Comment {
  ...
  final String id;
  final String announcementId; // This will be targetId (can be announcement, university, hospital, etc.)
  final String userName;
  final String commentText;
  final DateTime timestamp;
  final String status; // "pending" or "approved"
  final String targetType; // "announcement", "university", "hospital", "mall", etc.
  final String targetName; // Display name: "Atilim University", "ANKAmall", etc.
